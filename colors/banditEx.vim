...
let ColourAssignment['Normal']          = {"GUIFG": 'White',       "GUIBG":  'grey17'}
...
let ColourAssignment['Constant']        = {"GUIFG": '#FF8000',     "CTERMFG": 'Yellow',    "TERM":  'Underline'}
let ColourAssignment['String']          = {"GUIFG": '#FF8000'}

" Preprocessor directives are bold shades of blue
let ColourAssignment['PreProc']         = {"GUIFG": '#8080FF',        "GUI":     'Bold',      "TERM":  'Underline'}
let ColourAssignment['Include']         = {"GUIFG": '#8080FF',        "GUI":     'Bold'} " preprocessor #include
let ColourAssignment['Define']          = {"GUIFG": '#8080FF',     "GUI":     'Bold'} " preprocessor #define
let ColourAssignment['Macro']           = {"GUIFG": '#FF00FF',     "GUI":     'Bold'} " same as Define
let ColourAssignment['PreCondit']       = {"GUIFG": '#8080FF',     "GUI":     'Bold'} " preprocessor #if, #else, #endif, etc.

" Statements are shades of Blue
let ColourAssignment['Statement']       = {"GUIFG": '#3f9fef',        "TERM":    'Bold'}
let ColourAssignment['Conditional']     = {"GUIFG": '#3f9fef'} " if, then, else, endif, switch, etc.
let ColourAssignment['Repeat']          = {"GUIFG": '#3f9fef'} " for, do, while, etc.
let ColourAssignment['Label']           = {"GUIFG": '#3f9fef'} " case, default, etc.
let ColourAssignment['Exception']       = {"GUIFG": '#3f9fef'} " try, catch, throw
...
let ColourAssignment['Function']        = {"GUIFG": '#FF00FF',     "CTERMFG": 'Cyan'}

" Special additions created by mktypes.py are shades of Purple or Grey
let ColourAssignment['ClassName']       = {"GUIFG": '#8080FF',      "GUI":     'Bold',      "TERM":  'Underline'}
...
let ColourAssignment['Type']            = {"GUIFG": '#3f9fef',     "TERM":    'Underline'}
let ColourAssignment['StorageClass']    = {"GUIFG": '#3f9fef'} " static, register, volatile, etc.
let ColourAssignment['Structure']       = {"GUIFG": '#3f9fef'} " struct, union, enum, etc.
...
" Stuff needing doing
let ColourAssignment['Todo']            = {"GUIFG": 'Blue',        "GUIBG":   'Gray30',    "TERM":  'Standout'}

" Folding
let ColourAssignment['FoldColumn']      = {"GUIFG": 'tan',    "GUIBG":   'Gray30'}

let ColourAssignment['Folded']          = {"GUIFG": 'DarkSlateGray3', "GUIBG": 'grey30'}

" Popup Menu
let ColourAssignment['Pmenu']           = {"GUIFG": '#442206',     "GUIBG": '#ffff77',     "CTERMFG": "Black",   "CTERMBG": "Yellow"}

" Line Numbering
let ColourAssignment['LineNr']          = {"GUIFG": 'burlywood3',      "GUIBG": 'grey17'}

" Status Lines
let ColourAssignment['StatusLine']      = {"GUIFG": 'Black',       "GUIBG": '#ff8000',   "GUI": "Bold"}
let ColourAssignment['StatusLineNC']    = {"GUIFG": 'grey',       "GUIBG": 'grey40',    "GUI": "Bold"}
let ColourAssignment['TabLine']         = {"GUIFG": 'grey',       "GUIBG": 'grey40',    "GUI": "Bold"}
let ColourAssignment['TabLineSel']      = {"GUIFG": 'Black',      "GUIBG": '#ff8000',   "GUI": "Bold" }
let ColourAssignment['TabLineFill']     = {"GUIBG": 'grey30'}

" Search
let ColourAssignment['Search']          = {"GUIFG": 'gray80',     "GUIBG": '#445599',   "GUI":"none"}

" Vertical Splits
let ColourAssignment['VertSplit']       = {"GUIFG": 'gray',       "GUIBG": "grey40",       "GUI": "Bold"}
